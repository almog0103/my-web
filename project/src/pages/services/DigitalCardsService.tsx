...
const features = [
  'עיצוב מותאם אישית למיתוג',
  'שיתוף קל ומהיר',
  'אינטגרציה עם רשתות חברתיות',
  'סטטיסטיקות צפייה ושימוש',
  'עדכון פרטים בזמן אמת',
  'תמיכה בשפות מרובות'
];

const DigitalCardsService = () => {
  return (
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-[#034078]/10 text-[#1282A2] backdrop-blur-sm">
              ...
              <span>כרטיסי ביקור דיגיטליים</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-[#FEFCFB] leading-tight">
              הדרך החדשה ליצור <span className="text-[#1282A2]">קשרים עסקיים</span>
            </h1>
            <p className="text-lg text-[#FEFCFB]/80">
              כרטיסי ביקור דיגיטליים חכמים שמשלבים את כל המידע העסקי שלך במקום אחד,
              עם אפשרויות שיתוף מתקדמות ועיצוב מרהיב.
            </p>
        ...
        <div className="mt-24 text-center bg-[#034078]/20 rounded-2xl p-12 backdrop-blur-sm">
          ...
          <p className="text-xl text-[#FEFCFB]/80 mb-8 max-w-2xl mx-auto">
            צור כרטיס ביקור דיגיטלי מרשים שישאיר רושם בלתי נשכח
          </p>
          <Link
            to="/contact"
...
export default DigitalCardsService;